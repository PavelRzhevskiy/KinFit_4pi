...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/store11/eakozyrev/4pi/toy_july_2022/raw/2pi2pi0/tr_ph_run000107.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/store11/eakozyrev/4pi/toy_july_2022/raw/2pi2pi0/tr_ph_run000107.root");
      }
